...
class player_ui extends e_admin_ui
{
	...
	//	protected $listQry      	= "SELECT * FROM `#tableName` WHERE field != '' "; // Example Custom Query. LEFT JOINS allowed. Should be without any Order or Limit.
		...
		protected $fields 		= array (  'checkboxes' =>   array ( 'title' => '', 'type' => null, 'data' => null, 'width' => '5%', 'thclass' => 'center', 'forced' => '1', 'class' => 'center', 'toggle' => 'e-multiselect',  ),
		  ...
		  'icon' =>   array ( 'title' => 'Logo Societa\'', 'type' => 'icon', 'data' => 'str', 'width' => 'auto', 'inline' => true, 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
		...
		protected $fieldpref = array('id', 'icon', 'foto', 'nomecognome', 'datanascita', 'altezza', 'nazionalita', 'nick', 'ruolo', 'numeromaglia', 'urlinstagram', 'urlfacebook', 'urltwitter', 'societa', 'annoingresso', 'note', 'active', 'incarico', 'visibile');
	...
	//	protected $preftabs        = array('General', 'Other' );
		...
		public function init()
		{
			...
			$this->fields['ruolo']['writeParms']['optArray'] = array('', 'Palleggiatore','Schiacciatore', 'Opposto', 'Centrale', 'Libero', 'Allenatore', '2* Allenatore', 'Direttore Sportivo', 'Direttore Tecnico', 'Presidente', 'Vice Presidente', 'Preparatore Atletico', 'Massaggiatore', 'Medico', 'Staff-Dirigenti', ''); // Example Drop-down array. 
			$this->fields['incarico']['writeParms']['optArray'] = array('', 'Capitano','Vice Capitano'); // Example Drop-down array. 
